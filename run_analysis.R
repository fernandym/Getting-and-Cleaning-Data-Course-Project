...
names(df_merge_all_act_desc_tidy) = 
  gsub("-mean()", "mean", names(df_merge_all_act_desc_tidy), ignore.case = TRUE)
names(df_merge_all_act_desc_tidy) = 
  gsub("-std()", "stdev", names(df_merge_all_act_desc_tidy), ignore.case = TRUE)
names(df_merge_all_act_desc_tidy) = 
  gsub("-freq()", "frequency", names(df_merge_all_act_desc_tidy), ignore.case = TRUE)
names(df_merge_all_act_desc_tidy) = 
  gsub("^f", "frequency", names(df_merge_all_act_desc_tidy))
names(df_merge_all_act_desc_tidy) = 
  gsub("Gyro", "gyroscope", names(df_merge_all_act_desc_tidy))
names(df_merge_all_act_desc_tidy) = 
  gsub("^t", "time", names(df_merge_all_act_desc_tidy))
